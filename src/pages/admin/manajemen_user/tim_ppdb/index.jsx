...
const Index = () => {
  ...
  const edit = (id) => {
    router.push({
      pathname: "/admin/manajemen_user/tim_ppdb/update/[id]",
      query: { id: id },
    });
  };
  ...
  const filteredItems = dataTim.filter((item) =>
  ...
  return (
    <>
      <Main>
        <Container>
          <HeaderAdmin loading={loading} title="tim PPDB" />
          <input
            type="text"
            value={searchTerm}
            onChange={handleSearch}
            className="form-control mb-2 w-50"
            placeholder="Cari tim ppdb berdasarkan nama..."
          />
          ...
          {loading ? (
            ...
            <>
              ...
              <Link
                href="/admin/manajemen_user/tim_ppdb/create/"
                legacyBehavior
              >
                <Button
                  className="float-end"
                ...
                >
                  <PlusCircle className="me-1"></PlusCircle> Tambah akun tim
                  ppdb
                </Button>
              </Link>
              <Pagination>
